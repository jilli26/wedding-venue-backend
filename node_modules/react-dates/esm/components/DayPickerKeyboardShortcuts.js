      ...
      function render() {
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'span',
              css(styles.DayPickerKeyboardShortcuts_showSpan, bottomRight && styles.DayPickerKeyboardShortcuts_showSpan__bottomRight, topRight && styles.DayPickerKeyboardShortcuts_showSpan__topRight, topLeft && styles.DayPickerKeyboardShortcuts_showSpan__topLeft),
              '?'
            )
          ),
          showKeyboardShortcutsPanel && React.createElement(
            'div',
            _extends({}, css(styles.DayPickerKeyboardShortcuts_panel, block && styles.DayPickerKeyboardShortcuts_panel__block), {
              role: 'dialog',
              'aria-labelledby': 'DayPickerKeyboardShortcuts__title'
            }),
            React.createElement(
              'div',
              _extends({}, css(styles.DayPickerKeyboardShortcuts_title), {
            ...
            React.createElement(
              'button',
              _extends({}, css(styles.DayPickerKeyboardShortcuts_buttonReset, styles.DayPickerKeyboardShortcuts_close), {
                type: 'button',
              ...
              React.createElement(CloseButton, css(styles.DayPickerKeyboardShortcuts_closeSvg))
            ),
            React.createElement(
              'ul',
              css(styles.DayPickerKeyboardShortcuts__list),
              keyboardShortcuts.map(function (_ref2) {
